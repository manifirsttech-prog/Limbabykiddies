...
import { GiHeartBeats, GiShield } from 'react-icons/gi';
...
export default function AboutPage() {
  return (
    <main>
      {/* Hero */}
      <section className="bg-gradient-to-br from-pink-50 to-purple-50 py-16 md:py-24 relative overflow-hidden">
        {/* Floating emojis */}
        <div className="absolute inset-0 pointer-events-none">
          <motion.div animate={{ y: [0, -20, 0], rotate: [0, 10, 0] }} transition={{ duration: 5, repeat: Infinity }} className="absolute top-20 left-10 text-4xl opacity-20">👶</motion.div>
          <motion.div animate={{ y: [0, 15, 0] }} transition={{ duration: 4, repeat: Infinity }} className="absolute bottom-20 right-20 text-3xl opacity-20">🧸</motion.div>
          <motion.div animate={{ y: [0, -10, 0], x: [0, 10, 0] }} transition={{ duration: 6, repeat: Infinity }} className="absolute top-1/3 right-1/4 text-3xl opacity-20">🎀</motion.div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Our Story <AnimatedEmoji emoji="📖" size="md" animation="wiggle" />
            </h1>
            <p className="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
              LittleBloom 🌸 was born from a simple belief: every child deserves products that are safe 🛡️,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <AnimatedSection direction="right">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                ...
                every product has been carefully vetted for safety 🛡️, quality 💎, and joy 🎉.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We're driven by a deep commitment to children's wellbeing 👶 and parents' peace of mind 🧘‍♀️.
            </p>
          </AnimatedSection>
            ...
            <StaggerItem>
              <motion.div whileHover={{ y: -8, scale: 1.02 }} className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all border border-pink-100">
                <motion.div
                  ...
                  transition={{ duration: 0.6 }}
                  className="w-14 h-14 bg-pink-100 rounded-2xl flex items-center justify-center mb-4"
                >
                  <GiShield className="h-7 w-7 text-pink-500" />
                </motion.div>
            ...
            <StaggerItem>
              <motion.div whileHover={{ y: -8, scale: 1.02 }} className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all border border-blue-100">
                <motion.div
                  whileHover={{ rotate: 360 }}
                  transition={{ duration: 0.6 }}
                  className="w-14 h-14 bg-blue-100 rounded-2xl flex items-center justify-center mb-4"
                >
            ...
            <StaggerItem>
              <motion.div whileHover={{ y: -8, scale: 1.02 }} className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all border border-purple-100">
                <motion.div
                  whileHover={{ rotate: 360 }}
                  transition={{ duration: 0.6 }}
                  className="w-14 h-14 bg-purple-100 rounded-2xl flex items-center justify-center mb-4"
                >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            <AnimatedEmoji emoji="🌟" size="xl" animation="pulse" className="mb-4" />
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              Because Every Moment Matters ⏰
            </h2>
            <p className="text-lg text-gray-600 leading-relaxed mb-6">
              Childhood is fleeting 🦋. The first steps 👣, the first words 🗣️, the first day of school 🎒 —
              these moments shape who our children become. At LittleBloom 🌸, we're honored to be part
              of these journeys, providing the tools 🛠️, comfort 🛋️, and joy 🎉 that make each day a little
              more magical ✨.
            </p>
